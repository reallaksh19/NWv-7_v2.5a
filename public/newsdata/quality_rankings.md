...
- Overall status: **FAIL**
- Overall score: `0.3002`

## Destination scores

| Destination | Status | Score | Profile | Ranked items |
|---|---|---:|---|---:|
| upAhead | WARN | 0.8422 | `upAhead-v2-lifecycle-location-category` | 24 |
| buzz | FAIL | 0.0 | `buzz-v2-trend-local-travel` | 0 |
| localTravel | FAIL | 0.0 | `localTravel-v1-location-utility-disruption` | 0 |
| insight | WARN | 0.3587 | `insight-v2-event-angle-tree` | 11 |

## Findings

- 24 invalid/expired/duplicate Up Ahead item(s) suppressed
